...
// import 'package:social_medias/project/languages.dart';
// import 'package:social_medias/project/login.dart';
...
//                           child: ListTile(
//                             leading: Icon(
//                               Icons.video_collection_outlined, size: 60,
...
//                           color: Colors.white30,
//                           child: ListTile(
//                             leading: Icon(Icons.language, size: 60,
//                                 color: Colors.white60),
//                             contentPadding: EdgeInsets.all(16.0),
//                             title: GradientText(
//                               text: "Language",
...
//   ServiceList(Set<dynamic> service);
//
//
//
//   @override
//   Widget build(BuildContext context) {
//     final Service service;ServiceList({required this.service});
//     return Card(
//       child: Column(
